    ...
    <div class="produkSpace h-100 d-flex bg-body flex-column justify-content-evenly align-items-center" style="min-height: 100%; max-height:100%; min-width: 70%;">
        ...
        <div class="w-100 d-flex mb-5 justify-content-center align-items-center flex-1" style="min-height: 100%; max-height:100%;">
            <div class="area produks SecondScroll w-75 gap-4 d-flex flex-column overflow-y-auto h-100 justify-content-start align-items-center"
                style="width: fit-content; max-width: 100%; max-height: 60vh; min-height: 60vh;">
                @for($i=0;$i<=20;$i++)
                    <div class="produk{{{$i}}} align-items-center position-relative d-flex gap-2 flex-row justify-content-end align-items-end" style="height:200px; min-height: 200px; width: 470px;">
                    ...
                    <div class="position-absolute shadow z-0 pe-0 d-flex flex-row gap-1 justify-content-between align-items-end bg-prim-dark border-left-top border-right-bottom" style="right: 0; width:87%; height:95%; max-height: 95%; min-height: 95%;  ">
                        ...
                        <div class="buttonsArea bg-body d-flex flex-column justify-content-evenly align-items-center" style="min-width: 35px;max-width: 35px; height: 100%;">
                            <button type="button" class="d-flex cl-prim-dark justify-content-center align-items-center bg-transparent"
                                data-bs-toggle="popover" data-bs-trigger="hover" data-bs-title="Set Stok Awal" data-bs-content="Gunakan tombol ini untuk menetapkan jumlah stok awal barang sebelum jualan harian dimulai."><i class="bi bi-file-earmark-plus-fill"></i></button>
                            <button class="d-flex cl-prim-dark justify-content-center align-items-center bg-transparent"
                            data-bs-toggle="popover" data-bs-trigger="hover" data-bs-title="Set Stok Akhir" data-bs-content="Gunakan tombol ini untuk menyesuaikan stok berdasarkan hasil akhir masa jualan harian."> <i class="bi bi-file-earmark-minus-fill"></i></button>
                            <button class="d-flex cl-prim-dark justify-content-center align-items-center bg-transparent"
...
<div class="d-flex containerPopup bg-success d-flex flex-column justify-content-between width-full-xs z-3" style="width: 30%; height: 100%; right:0; top: 90px;">
    ...
    <div class="container d-flex flex-row gap-2 align-items-center justify-content-between" style="height: 100px; max-height: 100px; background-color: #6D2323;">
        ...
        <p class="p-clear h-auto" id="popupVendorDescription" style="color:rgba(253, 253, 253, 0.87);font-size: 10px; flex:1; overflow-y:auto;">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quae, tempore laboriosam! Ullam quae sapiente nesciunt adipisci temporibus, delectus dolorum omnis blanditiis laboriosam, earum accusantium a hic minima reiciendis iure cupiditate?</p>
    </div>
                ...
                <div class="w-100 h-100 d-flex flex-column gap-2 py-2 justify-content-center align-items-center initial-review-placeholder">
                    ...
                    @for($i=0;$i<=5;$i++)
                        ...
                        <div class="d-flex justify-content-between align-items-center w-100 h-auto">
                            <div class="d-flex flex-row gap-1" style="font-size: 8px;">Tes</div>
                            <p class="p-clear cl-prim-dark fw-bolder" style="font-size: 13px;">toko</p>
                        </div>
                        <div class="w-100" style="flex:1; overflow: auto;">
                            <p class="p-clear" style="font-size: 10px; text-indent: 12px; text-align: justify;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque dolore incidunt ipsam quam asperiores cum laborum. Laborum minus corporis blanditiis perspiciatis et iste, nobis a eum tempora, sunt culpa minima./p>
                        </div>
                </div>
                @endfor
            </div>
